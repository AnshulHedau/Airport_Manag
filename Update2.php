   ...
   <body>
      <?php
         ...
         if(isset($_POST['add'])) {
            ...
            $id = $_POST['password'];
			$sql1 = "update employee set Phone='$Phone' where AIRPORT_CODE=(select AIRPORT_CODE from admins where Admin='$User' and Password='$Pass') and id='$id';";
