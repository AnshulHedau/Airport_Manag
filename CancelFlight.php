      ...
      <?php
        include('style.php');
         if(isset($_POST['add'])) {
            ...
            $id = $_POST['password'];
			$sql1 = "delete from Flights where FROM_AIRPORT_CODE==(select AIRPORT_CODE from admins where Admin='$User' and Password='$Pass') and Flight_Id='$id' and Airlines_name='$Code';";
            mysqli_select_db( $conn,'test_db');
            $retval1 =  mysqli_query( $conn , $sql1);
            echo"<h2><br /><br /><center> Flight Cancelled Successfully </center></h2>";
