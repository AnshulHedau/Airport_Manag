...
<html>
   ...
   <meta charset="utf-8">
		...
		text-align:center;
		font-family:Roboto;padding-top: 40px;
	        padding-bottom: 40px;
   ...
   <body>
      <?php
         ...
         if(isset($_POST['add'])) {
			...
			$sql1 = "update flights set DEPT_TIME=addtime(DEPT_TIME,'$time'),ARRIVAL_TIME=addtime(ARRIVAL_TIME,'$time') where FLIGHT_ID ='$id';";
	...
	    					<div class='col-sm-1 col-sm-offset-1'>
            ...
            $retval2 =  mysqli_query( $conn , $sql2);
			$sql1 = "update flights set DEPT_TIME=subtime(DEPT_TIME,'$time'),ARRIVAL_TIME=subtime(ARRIVAL_TIME,'$time') where FLIGHT_ID ='$id';";
            mysqli_select_db( $conn,'test_db');
            $retval1 =  mysqli_query( $conn , $sql1);
            $sql = "Select * from flights where FLIGHT_ID ='$id';";
	...
	    					<div class='col-sm-1 col-sm-offset-1'>
			...
			<div class="container">
					...
					<form class="form-signin" method = "post" action = "<?php $_PHP_SELF ?>">
						<center>
							<input type='text' id = "Name" name='Name'pattern="[0-9][0-9]:[0-9][0-9]:[0-9][0-9]" placeholder="Change in Time" required><br />
						<br/>
						...
						<br/>
							...
							<button id = "add" name = "add" type="submit" class="btn btn-info">
								<i class="icon-ok icon-white"></i> ADD TIME
							</button>
							<br /><br />
							<button id = "add1" name = "add1" type="submit" class="btn btn-info">
								<i class="icon-ok icon-white"></i> SUBTRACT TIME
							</button>
							<br /><br />
