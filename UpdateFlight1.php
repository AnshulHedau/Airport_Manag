   ...
   <body>
      <?php
        ...
        if(isset($_POST['add1'])) {
			...
			$sql1 = "update Flights set Baggage_counter='$bag' where FROM_AIRPORT_CODE=(select AIRPORT_CODE from admins where Admin='$User' and Password='$Pass') and Flight_ID='$id';";
